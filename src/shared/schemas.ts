...
export interface AnalysisRequest { schemaVersion: '1'; requestId: string; documentRevision: number; targetLanguage: 'EN' | 'ES' | 'CN' | string; writingStyle?: 'practical' | 'elegant'; units: AnalysisUnit[]; }
...
export interface FullDocumentRequest { schemaVersion: '1'; requestId: string; documentRevision: number; text: string; targetLanguage?: 'EN' | 'ES' | 'CN' | string; writingStyle?: 'practical' | 'elegant'; }
