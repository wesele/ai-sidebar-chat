...
export interface AnalysisRequest { schemaVersion: '1'; requestId: string; documentRevision: number; targetLanguage: 'en'; units: AnalysisUnit[]; }
...
export interface FullDocumentRequest { schemaVersion: '1'; requestId: string; documentRevision: number; text: string; }
